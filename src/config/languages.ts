...
export const LANGUAGES: Record<StudyLanguage, LanguageConfig> = {
  fr: {
    ...
    textPlaceholder: 'Pega aquí tu lección en francés. Si deja el título vacío, se usará la primera oración como título. Cada oración termina con un punto, un signo de interrogación o un signo de exclamación.',
  ...
  en: {
    ...
    appTitle: 'Word Gym',
    subtitle: 'Práctica personalizada de idiomas',
    textPlaceholder: 'Pega aquí tu lección en inglés. Si deja el título vacío, se usará la primera oración como título. Cada oración termina con un punto, un signo de interrogación o un signo de exclamación. No uses mayúsculas al inicio de las oraciones.',
